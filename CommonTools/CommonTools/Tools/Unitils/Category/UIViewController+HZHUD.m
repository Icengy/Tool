...
static const CGFloat DELAY_TIME = 2;
...
+ (MBProgressHUD *)showMessage:(NSString *)message view:(UIView *)view yOffset:(CGFloat)offset duration:(CGFloat)second
{
    MBProgressHUD *hud = [self hudWithText:nil detail:message toView:view yOffset:offset];
    hud.mode = MBProgressHUDModeText;
    hud.margin = 10.0f;
...
+ (MBProgressHUD *)showWindowMessage:(NSString *)message duration:(CGFloat)second {
    return [self showMessage:message view:nil yOffset:0 duration:second];
}
