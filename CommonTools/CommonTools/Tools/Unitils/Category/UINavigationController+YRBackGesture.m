...
//    if ([touch.view isKindOfClass:[ESHBuyBonusView class]]){
//        return NO;
//    }
//    if ([touch.view isKindOfClass:[StepSlider class]]) {
//        return NO;
//    }
//    for (UIView *next = [touch.view superview] ; next; next = next.superview) {
//        UIResponder *nextResponder = [next nextResponder];
//        if ([nextResponder isKindOfClass:[ESZQDGAndHGBetsTableViewCell class]]||[nextResponder isKindOfClass:[ESDGAndHGBetsTableViewCell class]]||[nextResponder isKindOfClass:[ESSPFAndRQSPFBetsTableViewCell class]]||[nextResponder isKindOfClass:[ESTicketBetsTableViewCell class]]) {
//            return NO;
//        }
//    }
//    if ([touch.view isKindOfClass:[ESJCMCNView class]]) {
//        return NO;
//    }
    return YES;
}
