...
-(void)setupBackItemUI
{
    ...
    [back_btn setImage:[UIImage imageNamed:@"YKC_blackback"] forState:UIControlStateNormal];
    [back_btn setImage:[UIImage imageNamed:@"YKC_blackback"] forState:UIControlStateHighlighted];
